...
import { saveUserAccount, } from "../../../store/Actions/Users"
...
class AddUsers extends Component {
  ...
  AccountSubmit = event => {
    ...
    this.props.saveUserAccount(data, this.props.history);
                    ...
                    <ul className="nav nav-pills nav-justified" role="tablist">
                      <li className="nav-item waves-effect waves-light">
                        <a className="nav-link active" data-toggle="tab" href="#home-1" role="tab">
                          <span className="d-none d-md-block">Account</span><span className="d-block d-md-none"><i className="mdi mdi-home-variant h5"></i></span>
                        </a>
                      </li>
                      <li className="nav-item waves-effect waves-light">
                          ...
                          <div className="row">
                            <div class="col-4">
                              <div className="form-group">
                                ...
                                <input id="first_name" name="FirstName" onChange={this.adding} value={this.state.FirstName} type="text" className="form-control" />
                              </div>
                            </div>
                            <div class="col-4">
                              <div className="form-group">
                                <label for="last_name">Last Name</label>
                                <input id="last_name" name="LastName" onChange={this.adding} value={this.state.LastName} type="text" className="form-control" />
                              </div>
                            </div>
                            <div className="col-4">
                              <div className="form-group">
                                <label for="email">Email</label>
                                <input id="email" name="Email" onChange={this.adding} value={this.state.Email} type="text" className="form-control" />
                              </div>
                            </div>
                          </div>
                          <div className="row">
                            <div class="col-4">
                              <div className="form-group">
                                ...
                                <input id="value" name="Roles" onChange={this.adding} value={this.state.Roles} type="text" className="form-control" />
                              </div>
                            </div>
                            <div className="col-4">
                              <div className="form-group">
                                <label for="productdesc">Password</label>
                                <input id="roles" name="Password" onChange={this.adding} value={this.state.Password} type="text" className="form-control" />
                              </div>
                            </div>
                            <div class="col-4">
                              <div className="form-group">
                                <label for="confirm_pass">Confirm Password</label>
                                <input id="confirm_pass" name="ConfirmPassword" onChange={this.adding} value={this.state.ConfirmPassword} type="text" className="form-control" />
                              </div>
                            </div>
                          </div>
                          <div className="row">
...
&nbsp; &nbsp; &nbsp;<label >Inherit</label>
                                    ...
                                    <div className="permission-row">
                                      <div className="row">
                                        <div className="col-md-5 col-sm-4">
                                          <span className="permission-label">Delete roles</span></div>
                                        <div className="col-md-7 col-sm-8">
                                          <div className="row">
                                            <div class="col-4">
                                              <input type="radio" defaultValue={0} id="admin.roles-delete-inherit" name="permissions[admin.roles.delete]" className="permission-delete" checked />&nbsp; &nbsp; &nbsp;<label >Allow</label>
                                            </div>
                                            <div class="col-4">
                                              <input type="radio" defaultValue={0} id="admin.roles-delete-inherit" name="permissions[admin.roles.delete]" className="permission-delete" />&nbsp; &nbsp; &nbsp;<label >Deny</label>
                                            </div>
                                            <div class="col-4">
                                              <input type="radio" defaultValue={0} id="admin.roles-delete-inherit" name="permissions[admin.roles.delete]" className="permission-delete" />&nbsp; &nbsp; &nbsp;<label >Inherit</label>
                                            </div>
                                          </div>
                                        </div>
                                      </div>
...
&nbsp; &nbsp; &nbsp;<label >Inherit</label>
                          ...
                          <button type="button" value='add_new' class="btn btn-default btn-primary waves-effect waves-light" id="add-new-attribute">Save</button>
                        </form>
                        </div>
                    </div>
                  </div>
